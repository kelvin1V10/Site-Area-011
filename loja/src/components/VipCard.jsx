  ...
  return (
    ...
    >
      <div className="flex flex-col items-center flex-1">
        {/* Imagem */}
        <div className="w-25 h-24 mb-1 rounded-lg overflow-hidden border border-red-500 shadow-[0_0_6px_rgba(255,0,0,0.4)] bg-gray-900 flex items-center justify-center">
          <motion.img
